...
public class AudioRecordView {
    ...
    private View layoutAttachment, layoutDustin, imageViewAttachment, btnGallery;
        ...
        editTextMessage.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.toString().trim().isEmpty()) {
                    ...
                    if (showCameraIcon) {
                        if (btnGallery.getVisibility() != View.VISIBLE && !isLocked) {
                            btnGallery.setVisibility(View.VISIBLE);
                            btnGallery.animate().scaleX(1f).scaleY(1f).setDuration(100).setInterpolator(new LinearInterpolator()).start();
                        }
                    }
                    ...
                    if (showCameraIcon) {
                        if (btnGallery.getVisibility() != View.GONE) {
                            btnGallery.setVisibility(View.GONE);
                            btnGallery.animate().scaleX(0f).scaleY(0f).setDuration(100).setInterpolator(new LinearInterpolator()).start();
                        }
                    }
                }
            }
